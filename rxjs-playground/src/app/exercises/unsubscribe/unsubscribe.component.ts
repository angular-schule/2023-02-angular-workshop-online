...
import { Subject, ReplaySubject, timer, Subscription, takeWhile, takeUntil, take, interval, tap, throwError, switchMap, EMPTY } from 'rxjs';
...
export class UnsubscribeComponent implements OnDestroy {
  ...
  ngOnDestroy() {
    this.destroy$.next();
    // this.destroy$.complete(); // nicht notwendig
  }
